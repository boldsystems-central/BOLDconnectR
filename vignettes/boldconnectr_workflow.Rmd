...
output:
  html_document:
    ...
    self_contained: true
vignette: >
  %\VignetteIndexEntry{Cerambycidae of Canada: A BOLD.NODE + BOLDconnectR Workflow}
...
For more/detailed information, please visit (<https://github.com/boldsystems-central/BOLDconnectR/tree/main>) or use the `help` function in R.
