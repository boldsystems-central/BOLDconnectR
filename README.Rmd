...
```{r setup,warning=FALSE,message=F,eval=F}
...
```{r align_sequence,message=F,warning=F,eval=F}
...
```{r visualize_tree,message=F,warning=F,eval=F}
...
```{r biodiversity_analysis,message=F,warning=F,eval=F}
...
```{r occurrence_maps,message=F,warning=F,eval=F}
