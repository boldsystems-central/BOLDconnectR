...
```{r BOLDconnectR import,echo=FALSE}
...
knitr::kable(head(comm.data.grid$comm.matrix,10))

```

## analyze.alphadiv

```{r alphadiv,fig.width=6, fig.align='center',warning=FALSE}
...
```{r betadiv,fig.width=12,fig.height=6, fig.align='center',warning=FALSE}
...
```{r gen.comm.mat,fig.width=8,fig.height=8, fig.align='center',warning=FALSE}
...
```{r analyze.seq,fig.width=6, fig.height=4, fig.align='center',warning=FALSE}
